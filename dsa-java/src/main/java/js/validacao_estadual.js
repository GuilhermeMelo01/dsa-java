export function validateInscricaoEstadual(inscricaoEstadual, UF) {
    switch (UF) {
        // Acre
        case 'AC':
            if (inscricaoEstadual.length === 13) {
                ...
                return primeiroDigitoVerificador === inscricaoEstadual[11] && segundoDigitoVerificador === inscricaoEstadual[12];
            }
            else {
                return false;
            }
        ...
        case 'DF':
            ...
            if (inscricaoEstadual.length === 13) {
                ...
                if (inscricaoEstadual[11] == digito1 && inscricaoEstadual[12] == digito2) {
                    return true;
                } else {
                    return false;
                }

            } else if (inscricaoEstadual.length === 12) {
                if (prefixosValidos.includes(inscricaoEstadual.substring(0, 2))) {
                    return true;
                } else {
                    return false;
                }
        ...
        case 'SP':
            ...
            if (inscricaoEstadual.length == 12) {
                ...
                // Calculando o segundo digito verificador
                numeros = inscricaoEstadual.substring(0, 11)
                ...
                if (inscricaoEstadual[8] == primeiroDigitoVerificador && inscricaoEstadual[11] == segundoDigitoVerificador) return true;
                else return false;
            } else return false;
...
export const validateAndFormatIE = (ie, uf) => {
    if (validateInscricaoEstadual(ie, uf)) {
